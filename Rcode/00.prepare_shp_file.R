...
setwd("./tree_PE_conservation-threats")
save.image("./Rdata/prepare_shp_files_final.RData")
# load("./prepare_shp_files_final.RData")
...
## import the alphahull shp file. As it was a bit big, I removed it at last in the RData file
...
#To keep running for spatial data with a minor range exceed
...
save(PAMA6hull_41835_110_nocover, file ="PAMA6hull_41835_110_nocover.Rdata")  
...
PAM_angiosperm <-lets.subsetPAM(tree.pam_new_110, tree_gtc16_angio$species,remove.cells = T)
...
angio_phylogeny <- keep.tip(tc_phylogeny, tree_gtc16_angio$species)
